...
// Voice recognition related code derived from https://appcoda.com/siri-speech-framework
class VoiceControlViewController: UIViewController, SFSpeechRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.voiceControlButton.layer.cornerRadius = 10
    ...
    /// Initialize the recording engine, start recording and recognition
    func startRecording() {
    ...
    /// Find command on firebase based on recogintion result
    ///
    /// - Parameter command: The recognition result
    ...
    /// If audio recognition result found in firebase, call this function to execute the command
    ///
    /// - Parameters:
